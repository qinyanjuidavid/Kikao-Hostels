# Generated by Django 3.2.9 on 2022-06-28 08:37
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('Administrator', 'Administrator'), ('Student', 'Student')], max_length=17, verbose_name='Role')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timestamp', models.DateTimeField(auto_now_add=True, verbose_name='timestamp')),
                ('job_id', models.CharField(blank=True, max_length=30, null=True, verbose_name='Job id no')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('course_name', models.CharField(max_length=257, verbose_name='course name')),
                ('code', models.CharField(max_length=47, unique=True, verbose_name='code')),
                ('duration', models.CharField(max_length=15, verbose_name='duration')),
                ('date_started', models.DateField(null=True, verbose_name='date started')),
                ('completion_date', models.DateField(null=True, verbose_name='completion date')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_of_birth', models.DateField(blank=True, null=True, verbose_name='date of birth')),
                ('timestamp', models.DateTimeField(auto_now_add=True, verbose_name='timestamp')),
                ('admission_no', models.CharField(blank=True, max_length=30, null=True, unique=True, verbose_name='student id')),
                ('course', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='accounts.course')),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'abstract': False,
